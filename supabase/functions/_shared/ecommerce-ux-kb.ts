...
export const FINDINGS_GUARDRAILS = [
  ...
  "DO flag genuine overlap and collision: floating widgets such as chat bubbles, loyalty or rewards badges, back-to-top buttons, and cookie or consent bars that sit on top of each other or cover real content (a product image, price, or button). Stacked or colliding floating icons in a corner are a real problem worth a finding, with the fix being to space them out, combine them, or move the less important one.",
