import type { CompetingSmsDetection } from "./competing-sms-detect.ts";
...
/** Ensure the competing-SMS finding is present in a 5-slot executive findings array. */
