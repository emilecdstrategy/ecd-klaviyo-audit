...
- To ask ANYTHING, call ask_user so the user gets clickable options (including yes/no). Never cram two decisions into one question, and never ask a question as plain chat text when discrete options exist.
