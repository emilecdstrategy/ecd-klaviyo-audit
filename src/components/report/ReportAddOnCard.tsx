      ...
      <div className="flex flex-1 flex-col p-5">
        <div className="mb-2.5 flex items-start justify-between gap-3">
          ...
          <div className="shrink-0 text-right">
            <div className="inline-flex flex-col items-end rounded-xl bg-indigo-50 px-2.5 py-1.5 ring-1 ring-indigo-100">
              {editMode ? (
                <>
                  <EditableCurrency
                  ...
                  <EditablePlainText
                    ...
                    className="mt-0.5 max-w-[140px] text-[10px] text-indigo-600"
                    as="p"
                ...
                <>
                  ...
                  <span className="mt-0.5 max-w-[140px] text-[10px] leading-snug text-indigo-600">
